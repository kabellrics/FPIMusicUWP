...
namespace FPIMusicUWP.Core.ModelDTO
{
    ...
    public partial class DeezerArtiste
    {
        ...
        public static DeezerArtiste FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<DeezerArtiste>(data, new Newtonsoft.Json.JsonSerializerSettings());

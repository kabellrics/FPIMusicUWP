...
namespace FPIMusicUWP.Core.ModelDTO
{
    ...
    public partial class CompilationAlbum
    {
        ...
        public static CompilationAlbum FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<CompilationAlbum>(data, new Newtonsoft.Json.JsonSerializerSettings());

...
namespace FPIMusicUWP.Core.ModelDTO
{
    ...
    public partial class DeezerPlaylist
    {
        ...
        public static DeezerPlaylist FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<DeezerPlaylist>(data, new Newtonsoft.Json.JsonSerializerSettings());

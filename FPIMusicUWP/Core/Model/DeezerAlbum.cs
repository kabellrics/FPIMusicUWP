...
namespace FPIMusicUWP.Core.ModelDTO
{
    ...
    public partial class DeezerAlbum
    {
        ...
        public static DeezerAlbum FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<DeezerAlbum>(data, new Newtonsoft.Json.JsonSerializerSettings());

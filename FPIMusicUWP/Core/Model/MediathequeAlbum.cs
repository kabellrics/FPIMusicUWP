...
namespace FPIMusicUWP.Core.ModelDTO
{
    ...
    public partial class MediathequeAlbum
    {
        ...
        public static MediathequeAlbum FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<MediathequeAlbum>(data, new Newtonsoft.Json.JsonSerializerSettings());

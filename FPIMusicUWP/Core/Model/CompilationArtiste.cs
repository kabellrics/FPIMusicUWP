...
namespace FPIMusicUWP.Core.ModelDTO
{
    ...
    public partial class CompilationArtiste
    {
        ...
        public static CompilationArtiste FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<CompilationArtiste>(data, new Newtonsoft.Json.JsonSerializerSettings());

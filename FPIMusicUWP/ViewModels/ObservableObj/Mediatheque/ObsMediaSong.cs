...
{
    public class ObsMediaSong : ObservableObject
    {
        public MediathequeSong Song;
        private string apiUrl;
        private bool _selected;
        public ObsMediaSong(MediathequeSong sg, string Url)
        {
            Song = sg;
            apiUrl = Url;
            Selected = false;
        ...
        public string DisplayCover
        {
            ...
            get => $"{apiUrl}/api/Img/MediaAlb/{Song.AlbumId.ToString()}";

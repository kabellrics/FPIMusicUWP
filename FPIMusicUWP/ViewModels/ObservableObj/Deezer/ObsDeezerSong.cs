...
{
    public class ObsDeezerSong : ObservableObject
    {
        public DeezerSong Song;
        private string apiUrl;
        private bool _selected;
        public ObsDeezerSong(DeezerSong sg, string Url)
        {
            Song = sg;
            apiUrl = Url;
            Selected = false;
        ...
        public string DisplayCover
        {
            ...
            get => $"{apiUrl}/api/Img/DeezerAlb/{Song.AlbumId.ToString()}";
